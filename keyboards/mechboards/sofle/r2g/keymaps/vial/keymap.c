...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    SC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, QK_CAPS_WORD_TOGGLE, KC_END, KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, SC_RSPC,
                      KC_LGUI, KC_LALT, KC_LCTL, MO(1),   KC_SPC,         KC_ENT,  MO(2),   KC_MINS, KC_LBRC, KC_RBRC,
